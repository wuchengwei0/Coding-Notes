...
3. 新建仓库 - 创建
   ![Obsidian_01](Obsidian_01.png)

4. 安装插件

   - 设置 -->第三方插件 --> 关闭安全模式(才可以安装插件)

     ![Obsidian_02](Obsidian_02.png)

   - 设置 --> 第三方插件 --> 社区插件市场 --> 浏览

     ![Obsidian_03](Obsidian_03.png)

   - 搜索 Remotely Save --> 安装 --> 启用

![Obsidian_04](Obsidian_04.png)
